...
for i = 0:q-1
    ...
    dydt_lin_1 = y_0(3);
    dydt_lin_2 = y_0(4);
    dydt_lin_3 = (-3*g*((4*m1 + 5*m2)*(y_0(1)) + 3*m2*(y_0(1) - 2*y_0(2))))/((8*m1 + 15*m2 - 9*m2)*L1) + (9*m2*(2*(y_0(1) - y_0(2)))*(y_0(3)*y_0(3)))/(-8*m1 - 15*m2 + 9*m2) + (6*m2*(y_0(1) - y_0(2))*L2*(y_0(4)*y_0(4)))/((-4*(m1 + 3*m2) + 9*m2)*L1);
    dydt_lin_4 = (9*g*(m1 + 2*m2)*(2*y_0(1) - y_0(2)) - 3*g*(m1 + 6*m2)*(y_0(2)))/((8*m1 + 15*m2 - 9*m2)*L2) + (6*(m1 + 3*m2)*(y_0(1) - y_0(2))*L1*(y_0(3)*y_0(3)))/((4*(m1 + 3*m2) - 9*m2)*L2) + (9*m2*(2*(y_0(1) - y_0(2)))*(y_0(4)*y_0(4)))/(8*m1 + 15*m2 - 9*m2);
