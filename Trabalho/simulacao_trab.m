...
if -y_0(3) < phi
    ...
    dydt8 = (c_tf*y_0(6))/m_f + (cos(phi + y_0(3))*c_tf*D_fo*y_0(7))/m_f - ((c_rf + c_tf)*y_0(8))/m_f + (-(g*m_f) + k_tf*(sin(phi + y_0(3))*D_fo + y_0(2) - y_0(4)) + k_rf*(-y_0(4) + y_ext(t)) + c_rf*yponto_ext)/m_f;
    dydt9 = y_0(10);
    dydt10 = (-(M*g - C_L*S*rho*y_0(10)^2/2)*(u_rol)*C_pav - C_D*S*rho*y_0(7)^2/2)/M;
    dydt = [dydt1; dydt2; dydt3; dydt4; dydt5; dydt6; dydt7; dydt8; dydt9; dydt10];
end
