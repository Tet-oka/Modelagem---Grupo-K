...
figure(1)
plot(intervalo, resp_real(3:4,:), "b")
hold on
plot(intervalo, relf(3:4,:), "r")
legend( "", "Real do complexo conjugado", "Real positivo", "Real negativo")
...
hold on
plot(intervalovento, relf(3:4,:), "r")
legend( "", "Real do complexo conjugado", "Real positivo", "Real negativo" )
...
hold on
plot(intervaloang*180/pi, relf(3:4,:), "r")
legend( "", "Real do complexo conjugado", "Real positivo", "Real negativo" )
